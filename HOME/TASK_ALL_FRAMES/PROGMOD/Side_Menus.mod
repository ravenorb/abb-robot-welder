 MODULE Side_Menus
	...
	PROC rSelFrame()
		...
		TPReadFK regSelmenu01, "Select Frame Type", "Skid", "100-200", "300", "Other", "Return";
		TEST regSelmenu01
		CASE 1:
			rSelSkids;
		CASE 2:
	...
	ENDPROC
		...
		TPWrite "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
		rSelPrg100BDisplay;
		TPReadFK regSelmenu03, "Select frame to run", stEmpty, stEmpty, "SS 100 1A", "SS 200 1A", "Return";
		TEST regSelmenu03
		CASE 1:
	...
	ENDPROC
		...
		TPWrite "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
		rSelOtherBDisplay;
		TPReadFK regSelmenu05, "Select Part", stEmpty, stEmpty, "Rover", stEmpty, "Return";
		TEST regSelmenu05
		CASE 1:
			rSelOther;
		CASE 2:
